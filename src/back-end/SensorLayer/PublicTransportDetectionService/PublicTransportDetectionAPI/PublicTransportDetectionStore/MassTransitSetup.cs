...
{
    public static IServiceCollection AddPublicTransportDetectionMassTransit(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddMassTransit(x =>
        {
            x.UsingRabbitMq((context, cfg) =>
            {
                ...
                cfg.Message<PublicTransportMessage>(e => e.SetEntityName(sensorExchange));
                cfg.Publish<PublicTransportMessage>(e => e.ExchangeType = ExchangeType.Topic);
